...
const Process = () => {
  return (
    <div className="bg-gray-200 flex flex-col items-center md:px-28 px-10  pt-36">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="w-full lg:w-64 h-[380px] lg:h-[400px] mt-10 border-[#FC7F4B] rounded-t-full bg-transparent border-x-4 border-t-2 border-b-0">
            <div className="lg:absolute lg:-left-8 bottom-0 -mt-14 w-full ml-6 lg:ml-0">
              <img
                src={Avatar}
                alt="Handyman"
                className="h-[450px] lg:h-[450px] mx-auto"
              />
            </div>
          </div>
        </div>
        ...
        {/* Right Section */}
        <div className="flex order-1 lg:order-2 flex-col mt-4 px-4 relative">
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-52 items-center">
            <div className="flex flex-col text-center lg:text-left">
              <div className="flex mb-2 justify-center lg:justify-start space-x-2">
          ...
          {/* Process Steps */}
          <div className="flex flex-col lg:flex-row justify-between items-center mt-12 space-y-8 md:space-y-0 md:space-x-4 w-full">
            {/* Step 1 */}
            <div className="text-center mb-5 lg:mb-0 flex flex-col items-center">
              <div className="bg-white shadow-xl flex flex-col items-center justify-center p-4 w-40 h-40 lg:w-32 lg:h-32 rounded-full mb-4">
            ...
            <Redo className="hidden lg:block absolute bottom-32 inset-x-60 w-16 h-16 text-blue-600" />
            ...
            <Redo className="hidden lg:block absolute bottom-32 inset-x-[510px] w-16 h-16 text-blue-600" />
